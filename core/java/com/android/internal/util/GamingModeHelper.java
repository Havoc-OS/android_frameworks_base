...
public class GamingModeHelper {
    ...
    private static final String GAMING_MODE_PACKAGE = "com.android.game.mode";

    public static final int MSG_SEND_GAMING_MODE_BROADCAST = 60;

    public static final String ACTION_GAMING_MODE_ON = "android.intent.action.GAMING_MODE_ON";
    public static final String ACTION_GAMING_MODE_OFF = "android.intent.action.GAMING_MODE_OFF";
