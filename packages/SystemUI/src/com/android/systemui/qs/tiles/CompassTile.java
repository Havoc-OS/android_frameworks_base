...
public class CompassTile extends QSTileImpl<BooleanState> implements SensorEventListener {
    ...
    public boolean isAvailable() {
        return HavocUtils.deviceHasCompass(mContext);
    }
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (state.value) {
            ...
            if (arg != null) {
                state.secondaryLabel = formatValueWithCardinalDirection(degrees);
                ...
                state.secondaryLabel = mContext.getString(R.string.quick_settings_compass_init);
