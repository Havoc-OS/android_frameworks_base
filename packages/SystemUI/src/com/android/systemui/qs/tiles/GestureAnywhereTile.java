...
public class GestureAnywhereTile extends QSTileImpl<BooleanState> {
    ...
    public GestureAnywhereTile(QSHost host) {
        super(host);
        mSetting = new SecureSetting(mContext, mHandler, Secure.GESTURE_ANYWHERE_ENABLED  ) { 
            @Override 
    ...
    public CharSequence getTileLabel() { 
        return mContext.getString(R.string.gestureanywhere_title_tile); 
    } 
    ...
    protected void handleUpdateState(BooleanState state, Object arg) { 
        ...
        state.label = mContext.getString(R.string.gestureanywhere_title_tile);
        if (suspend) {
            state.contentDescription =  mContext.getString(
                    R.string.gestureanywhere_title_tile);
