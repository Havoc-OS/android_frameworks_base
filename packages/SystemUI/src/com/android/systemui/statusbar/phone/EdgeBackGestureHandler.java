...
public class EdgeBackGestureHandler extends CurrentUserTracker implements DisplayListener,
    ...
    private boolean mIsTriggerBackHapticEnabled;
    ...
    public void updateCurrentUserResources() {
        ...
        mIsTriggerBackHapticEnabled = mGestureNavigationSettingsObserver.getTriggerBackHaptic();
    ...
    private void onMotionEvent(MotionEvent ev) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            if (mAllowGesture) {
                ...
                mEdgeBackPlugin.setTriggerBackHaptic(mIsTriggerBackHapticEnabled);
