...
public abstract class CustomSettingsService {
    ...
    public abstract void addStringObserver(CustomSettingsObserver observer, String... keys);
    public abstract void addIntObserver(CustomSettingsObserver observer, String... keys);
    public abstract void removeObserver(CustomSettingsObserver observer);
