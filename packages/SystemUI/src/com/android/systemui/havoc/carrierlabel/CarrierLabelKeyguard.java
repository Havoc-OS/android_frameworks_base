...
public class CarrierLabelKeyguard extends TextView implements DarkReceiver, TunerService.Tunable {
    ...
    private static final String LOCK_SCREEN_SHOW_CARRIER =
            "system:" + Settings.System.LOCK_SCREEN_SHOW_CARRIER;

    public CarrierLabelKeyguard(Context context) {
        this(context, null);
    }

    public CarrierLabelKeyguard(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CarrierLabelKeyguard(Context context, AttributeSet attrs, int defStyle) {
