...
public class CustomTextClock extends TextView {
    ...
    private final String[] TensString = {
        "",
        "",
        res.getString(R.string.text_clock_tens_string_twenty),
    ...
    private final String[] UnitsString = {
        res.getString(R.string.text_clock_units_string_clock),
    ...
    private final String[] TensStringH = {
        "",
        "",
        res.getString(R.string.text_clock_tens_string_h_twenty),
    ...
    private final String[] UnitsStringH = {
        res.getString(R.string.text_clock_units_string_h_twelve_h),
